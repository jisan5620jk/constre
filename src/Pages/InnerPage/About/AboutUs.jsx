...
const AboutUs = () => {
  return (
    <section className="bg-[url('/assets/images/about/about_bg2.jpg')] bg-center bg-no-repeat py-28">
      <div className="Container grid grid-cols-1 lg:grid-cols-2 lg:gap-10 xl:gap-0 items-center">
        <div className="inline-block relative z-10 pb-9">
          <img src={AboutUsImg} />
        ...
        <div>
          ...
          <h1 className="text-[30px] sm:text-4xl leading-9 md:text-5xl lg:text-4xl xl:text-5xl font-bold mb-4 font-Yantramanav text-PrimaryColor-0 pt-3">
          ...
          <p className="font-Archivo text-[#575f66] font-light pt-2 mb-6">
            ...
            cross-platform markets. Synergistically aggregate enable compelling
            relationships more principle evolve open-source in whereas
            enterprise human capital
          </p>
          <div>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-y-3 lg:gap-x-0">
              ...
              <li className="font-Yantramanav text-lg text-PrimaryColor-0 font-medium flex items-center gap-2">
                <MdOutlineCheckCircleOutline className="text-xl" /> Best Quality
                Supports
              </li>
              <li className="font-Yantramanav text-lg text-PrimaryColor-0 font-medium flex items-center gap-2">
                <MdOutlineCheckCircleOutline className="text-xl" /> Satisfaction
                Gauranted
              </li>
              <li className="font-Yantramanav text-lg text-PrimaryColor-0 font-medium flex items-center gap-2">
                <MdOutlineCheckCircleOutline className="text-xl" /> 100% Timely
                Finised Work
              </li>
            </ul>
          </div>
          <div className="flex gap-5 flex-col sm:flex-row mt-10">
            ...
            <div className="flex gap-5 items-center">
              ...
              <div>
                ...
                <p className="text-sm font-Archivo font-light">CEO & Founder</p>
              </div>
            </div>
          </div>
        </div>
